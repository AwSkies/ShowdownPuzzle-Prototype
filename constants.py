...
MEGA_TOKEN = '@'
TERA_TOKEN = '#'
MODIFIER_TOKENS = MEGA_TOKEN + TERA_TOKEN

SWITCH_TOKEN = '>'
SWITCH_OPEN_BRACKET = '('
SWITCH_CLOSE_BRACKET = ')'

REPEAT_OPEN_BRACKET = '['
REPEAT_CLOSE_BRACKET = ']'

COMMENT_TOKEN = '//'

TOKENS = MOVE_TOKEN + MEGA_TOKEN + TERA_TOKEN + SWITCH_TOKEN + SWITCH_OPEN_BRACKET + SWITCH_CLOSE_BRACKET + REPEAT_OPEN_BRACKET + REPEAT_CLOSE_BRACKET

MOVE = "move"
SWITCH = "switch"
SET_SWITCH = "set_switch"
REPEAT_UNTIL_FAINT = "repeat_until_faint"
